...
import bochum.mpi.horstify.adapter.BasicBlock;
...
public abstract class Instruction implements Cloneable {
	...
	private final List<Instruction> isControlled = new LinkedList<>();

	public List<Instruction> getIsControlled() {
		return isControlled;
	}
	...
	public void addIsControlled(List<Instruction> instructions) {
		isControlled.addAll(instructions);
	}
